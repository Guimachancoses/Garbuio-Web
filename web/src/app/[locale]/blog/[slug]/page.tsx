...
import { MobileTableOfContents } from "@/src/components/mobile-toc";
import { AuthorCard } from "@/src/components/author-card";
import { ReadMoreSection } from "@/src/components/read-more-section";
import { PromoContent } from "@/src/components/promo-content";
import { getAuthor, isValidAuthor } from "@/src/lib/authors";
import { FlickeringGrid } from "@/src/components/magicui/flickering-grid";
import { HashScrollHandler } from "@/src/components/hash-scroll-handler";
...
export default async function BlogPost({ params }: PageProps) {
    ...
    return (
        <>
            ...
            >
                <div className="pt-15 border-b border-border min-h-screen bg-background relative">
                    <HashScrollHandler />
